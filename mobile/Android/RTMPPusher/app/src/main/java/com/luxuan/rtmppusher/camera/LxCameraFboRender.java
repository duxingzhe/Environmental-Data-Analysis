...
public class LxCameraFboRender {
    ...
    public void onDraw(int textureId){
        ...
        GLES20.glVertexAttribPointer(fPosition, 2, GLES20.GL_FLOAT, false, 8, vertexData.length);
