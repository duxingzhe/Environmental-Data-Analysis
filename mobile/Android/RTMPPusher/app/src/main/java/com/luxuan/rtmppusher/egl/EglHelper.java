...
public class EglHelper {
    ...
    public void initEgl(Surface surface, EGLContext eglContext){
        ...
        if(eglContext!=null){
            mEglContext=mEgl.eglCreateContext(mEglDisplay, configs[0], eglContext, attribute_list);
        }else{
            mEglContext=mEgl.eglCreateContext(mEglDisplay, configs[0], EGL10.EGL_NO_CONTEXT, attribute_list);
        }
