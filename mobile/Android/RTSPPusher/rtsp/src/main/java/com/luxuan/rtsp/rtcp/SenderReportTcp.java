...
public class SenderReportTcp extends BaseSenderReport {
    ...
    private void sendReportTCP(byte[] buffer, byte channelIdentifier, String type, int packet, int octet) throws IOException{
        synchronized(outputStream){
            ...
            Log.i(TAG, "wrote report: "+ type+", packets: "+packet+", oct: "+ octet);
        }
    }
}
