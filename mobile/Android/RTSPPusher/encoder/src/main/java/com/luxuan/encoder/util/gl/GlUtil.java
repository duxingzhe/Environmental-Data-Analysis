...
public class GlUtil {
    ...
    public static void createTextures(int candidate, int[] texturesId, int position){
        GLES20.glGenTextures(candidate, texturesId, position);
    ...
    public static void createExternalTextures(int candidate, int[] texturesId, int position){
        GLES20.glGenTextures(candidate, texturesId, position);
        for(int i=0;i<candidate;i++){
            GLES20.glActiveTexture(GLES20.GL_TEXTURE0+position+i);
